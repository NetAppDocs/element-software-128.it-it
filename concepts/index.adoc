...
summary: Apprendi i concetti di base relativi al software Element. 
---
= Concetti
:allow-uri-read: 
:icons: font
...
* xref:concept_solidfire_concepts_solidfire_architecture_overview.adoc[Panoramica dell'architettura SolidFire]
...
* xref:concept_data_manage_volumes_solidfire_quality_of_service.adoc[Prestazioni e qualità del servizio]
