...
summary: Scopri di più sulle opzioni del menu RTFI se il processo RTFI non riesce o se scegli di non procedere alla richiesta iniziale del processo RTFI. 
---
