...
. Nella sezione Abilita/Disabilita accesso supporto, inserisci la durata (in ore) per cui desideri consentire l'accesso al supporto.
. Fare clic su *Abilita accesso supporto*.
. *Facoltativo:* per disattivare l'accesso al supporto, fare clic su *Disattiva accesso al supporto*.
