...
summary: 'Dopo aver configurato il sistema SolidFire , potresti voler eseguire alcune attività facoltative.  Inoltre, è possibile configurare le impostazioni per l"autenticazione a più fattori, la gestione delle chiavi esterne e la sicurezza FIPS (Federal Information Processing Standards).' 
---
