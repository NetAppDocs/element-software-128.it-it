...
summary: Il metodo GetNetworkConfig restituisce una risposta simile al seguente esempio. 
---
...
[role="lead"]
IL `GetNetworkConfig` restituisce una risposta simile al seguente esempio.
