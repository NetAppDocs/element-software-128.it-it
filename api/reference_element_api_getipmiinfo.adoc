...
summary: 'È possibile utilizzare il metodo GetIpmiInfo per visualizzare un report dettagliato dei sensori \(oggetti\) per le ventole dei nodi, le temperature di aspirazione e di scarico e gli alimentatori monitorati dal sistema.' 
---
= OttieniIpmiInfo
:allow-uri-read: 
:icons: font
