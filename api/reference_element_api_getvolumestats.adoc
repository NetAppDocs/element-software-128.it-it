...
summary: È possibile utilizzare il metodo GetVolumeStats per ottenere misurazioni di attività di alto livello per un singolo volume.  I valori sono cumulativi a partire dalla creazione del volume. 
---
...
[role="lead"]
Puoi usare il `GetVolumeStats` metodo per ottenere misurazioni di attività di alto livello per un singolo volume.  I valori sono cumulativi a partire dalla creazione del volume.
...
volumeStats
 a| 
Informazioni sull'attività volumetrica.
 a| 
