...
[role="lead"]
Puoi usare il `ListActivePairedVolumes` metodo per elencare tutti i volumi attivi associati a un volume.  Questo metodo restituisce informazioni sui volumi con abbinamenti attivi e in sospeso.
...
volumi
 a| 
Informazioni sul volume per i volumi accoppiati.
 a| 
