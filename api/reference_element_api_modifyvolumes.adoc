...
summary: È possibile utilizzare il metodo ModifyVolumes per configurare fino a 500 volumi esistenti contemporaneamente.  I cambiamenti avvengono immediatamente.  Se ModifyVolumes non riesce a modificare nessuno dei volumi specificati, nessuno dei volumi specificati verrà modificato. 
---
= ModificaVolumi
:allow-uri-read: 
:icons: font
