...
summary: È possibile utilizzare il metodo ListServices per elencare le informazioni sui servizi per nodi, unità, software corrente e altri servizi in esecuzione sul cluster. 
---
= ElencoServizi
:allow-uri-read: 
:icons: font
...
[role="lead"]
Puoi usare il `ListServices` Metodo per elencare le informazioni sui servizi per nodi, unità, software corrente e altri servizi in esecuzione sul cluster.
...
servizi
 a| 
Servizi in esecuzione su unità e nodi.
 a| 
Oggetto JSON
