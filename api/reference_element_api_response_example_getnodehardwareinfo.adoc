...
summary: Il metodo GetNodeHardwareInfo per iSCSI restituisce una risposta simile al seguente esempio. 
---
...
[role="lead"]
IL `GetNodeHardwareInfo` metodo per iSCSI restituisce una risposta simile al seguente esempio.
