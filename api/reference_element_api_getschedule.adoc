...
[role="lead"]
Puoi usare `GetSchedule` per ottenere informazioni su uno snapshot pianificato.

È possibile visualizzare informazioni su una pianificazione specifica se nel sistema sono presenti molte pianificazioni snapshot.  Con questo metodo è possibile recuperare informazioni anche su più di una pianificazione specificando ID aggiuntivi nel parametro scheduleID.
...
IDprogramma
 a| 
ID univoco della pianificazione o delle più pianificazioni da visualizzare.
 a| 
intero
 a| 
Nessuno
...
programma
 a| 
Una serie di attributi di pianificazione.
 a| 
