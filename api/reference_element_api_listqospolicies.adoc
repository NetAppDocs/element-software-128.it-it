...
[role="lead"]
Puoi usare il `ListQoSPolicies` metodo per elencare le impostazioni di tutte le policy QoS sul sistema.
...
qosPolicies
 a| 
Un elenco di dettagli su ciascuna policy QoS.
 a| 
xref:reference_element_api_qospolicy.adoc[Politica QoSP]vettore
