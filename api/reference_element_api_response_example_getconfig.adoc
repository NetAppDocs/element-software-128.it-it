...
summary: Il metodo GetConfig restituisce una risposta simile al seguente esempio.  A causa della lunghezza, la risposta contiene informazioni solo per un nodo del cluster. 
---
= OttieniConfig
:allow-uri-read: 
:icons: font
...
[role="lead"]
IL `GetConfig` restituisce una risposta simile al seguente esempio.  A causa della lunghezza, la risposta contiene informazioni solo per un nodo del cluster.
