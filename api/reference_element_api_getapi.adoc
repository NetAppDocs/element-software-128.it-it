...
summary: È possibile utilizzare il metodo GetAPI per ottenere un elenco di tutti i metodi API e degli endpoint API supportati che possono essere utilizzati nel sistema. 
---
= OttieniAPI
:allow-uri-read: 
:icons: font
...
[role="lead"]
Puoi usare il `GetAPI` metodo per ottenere un elenco di tutti i metodi API e degli endpoint API supportati che possono essere utilizzati nel sistema.
...
<versione>
 a| 
Un elenco di tutti i metodi API supportati per questa versione del software, dove <versione> è la versione corrente del software in esecuzione su questo sistema.
 a| 
matrice di stringhe
...
versione corrente
 a| 
La versione corrente del software del cluster di archiviazione.
 a| 
corda
