...
---
= GetNodeHardwareInfo (output per i nodi Fibre Channel)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
IL `GetNodeHardwareInfo` Il metodo per i nodi Fibre Channel restituisce una risposta simile al seguente esempio.
