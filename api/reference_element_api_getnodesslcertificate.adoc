...
summary: È possibile utilizzare il metodo GetNodeSSLCertificate per recuperare il certificato SSL attualmente attivo sul nodo di gestione. 
---
= Ottieni certificato SSL nodo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puoi usare il `GetNodeSSLCertificate` metodo per recuperare il certificato SSL attualmente attivo sul nodo di gestione.
...
certificato
 a| 
Il testo completo del certificato codificato in PEM.
 a| 
corda
