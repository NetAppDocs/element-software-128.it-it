...
summary: Il metodo TestHardwareConfig restituisce una risposta simile al seguente esempio. 
---
= TestHardwareConfig
:allow-uri-read: 
:icons: font
...
[role="lead"]
IL `TestHardwareConfig` restituisce una risposta simile al seguente esempio.
