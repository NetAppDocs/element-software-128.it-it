...
summary: 'È possibile utilizzare questi metodi API per creare un cluster di archiviazione.  Tutti questi metodi devono essere utilizzati sull"endpoint API su un singolo nodo.' 
---
...
* xref:reference_element_api_getbootstrapconfig.adoc[OttieniBootstrapConfig]
